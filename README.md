...
1. **Breaking Changes**
   ...
   - TTMG integration doesn't play well with HASS web conversations (probably not fixable). Solution: don't use it with the web assistant! ¯\\_(ツ)_/¯
...
3. **Context-Awareness:**
   - TTS engines have no idea about the context - they process one sentence at a time. This sometimes affects intonation but in the absolute majority of cases it isn’t noticeable.
